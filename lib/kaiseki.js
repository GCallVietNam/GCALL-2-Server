...
var Kaiseki = function(applicationId, masterKey, sessionToken, serverUrl, mountPath) {
  ...
  this.mountPath = _.isUndefined(mountPath)? DEFAULT_MOUNT_PATH : mountPath;
...
Kaiseki.prototype = {
  ...
  updateSession: function(objectId, data, callback) {
    this._jsonRequest({
      method: 'PUT',
      url: '/sessions/' + objectId,
      params: data,
      callback: callback
    });
  },
